...
void Master::map(cli::bdev_map_param const &param) {
...
void Master::unmap(cli::bdev_unmap_param const &param) {
  auto nl_sock = genl::sock_open();
  auto msg = genl::msg_alloc();
...
void Master::create(cli::target_create_param const &param) {
...
void Master::destroy(cli::target_destroy_param const &param) {
